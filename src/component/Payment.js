                    ...
                    <div class="outer-box">
                        <div class="row">
                            ...
                            <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                                <div class="inner-box">
                                    <div class="icon-box">
                                        <div class="icon-outer"><img className='imuu' src='https://res.cloudinary.com/dgvvfn1gf/image/upload/v1675220810/new_logo_rhiway.png'></img></div>
                                    </div>
                                    <div class="price-box">
                                    ...
                                    <Link to='/login'>
                                    <div class="btn-box">
                                        <Link to='/login' class="theme-btn">BUY PLAN</Link>
                                    </div>
                                    </Link>
                            ...
                            <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                                <div class="inner-box">
                                    ...
                                    <div class="btn-box">
                                        <a href="https://img.freepik.com/free-vector/red-grunge-style-coming-soon-design_1017-26691.jpg" class="theme-btn">BUY PLAN</a>
                                    </div>
                                </div>
                            </div>
